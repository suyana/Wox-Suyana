...
namespace Wox
{
    public partial class MainWindow
    {
        ...
        private void OnInitialized(object sender, EventArgs e) {
            InternationalizationManager.Instance.ChangeMainDefaultLanguage();//suyana add
        ...
        private void OnDeactivated(object sender, EventArgs e)
        {
            ...
            {
                //suyana add，隐藏时且设置清空关键字时，清空关键字
                if (_settings.LastQueryMode == LastQueryMode.Empty && !string.IsNullOrEmpty(QueryTextBox.Text)) {
